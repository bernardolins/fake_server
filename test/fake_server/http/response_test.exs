defmodule ResponseTest do
  ...
  describe "#new" do
    ...
    test "accept the response body as map and return it as a json string" do
      assert Response.new(200, %{message: "This is a body", code: 1}) == %Response{code: 200, body: ~s<{"message":"This is a body","code":1}>, headers: %{}}
    end
  ...
  describe "2XX" do
    ...
    test "returns the correspondent status code with a map as response body" do
      assert Response.ok(%{status_kind: "2xx"}) == %Response{code: 200, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.created(%{status_kind: "2xx"}) == %Response{code: 201, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.accepted(%{status_kind: "2xx"}) == %Response{code: 202, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.non_authoritative_information(%{status_kind: "2xx"}) == %Response{code: 203, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.no_content(%{status_kind: "2xx"}) == %Response{code: 204, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.reset_content(%{status_kind: "2xx"}) == %Response{code: 205, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.partial_content(%{status_kind: "2xx"}) == %Response{code: 206, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.multi_status(%{status_kind: "2xx"}) == %Response{code: 207, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.already_reported(%{status_kind: "2xx"}) == %Response{code: 208, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
      assert Response.im_used(%{status_kind: "2xx"}) == %Response{code: 226, body: ~s<{"status_kind":"2xx"}>, headers: %{}}
    end
  end

  describe "4XX" do
    test "returns the correspondent status code with a map as response body" do
      assert Response.bad_request(%{status_kind: "4xx"})== %Response{code: 400, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.unauthorized(%{status_kind: "4xx"})== %Response{code: 401, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.payment_required(%{status_kind: "4xx"})== %Response{code: 402, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.forbidden(%{status_kind: "4xx"})== %Response{code: 403, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.not_found(%{status_kind: "4xx"})== %Response{code: 404, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.method_not_allowed(%{status_kind: "4xx"})== %Response{code: 405, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.not_acceptable(%{status_kind: "4xx"})== %Response{code: 406, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.proxy_authentication_required(%{status_kind: "4xx"})== %Response{code: 407, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.request_timeout(%{status_kind: "4xx"})== %Response{code: 408, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.conflict(%{status_kind: "4xx"})== %Response{code: 409, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.gone(%{status_kind: "4xx"})== %Response{code: 410, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.length_required(%{status_kind: "4xx"})== %Response{code: 411, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.precondition_failed(%{status_kind: "4xx"})== %Response{code: 412, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.payload_too_large(%{status_kind: "4xx"})== %Response{code: 413, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.uri_too_long(%{status_kind: "4xx"})== %Response{code: 414, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.unsupported_media_type(%{status_kind: "4xx"})== %Response{code: 415, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.expectation_failed(%{status_kind: "4xx"})== %Response{code: 417, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.im_a_teapot(%{status_kind: "4xx"})== %Response{code: 418, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.misdirected_request(%{status_kind: "4xx"})== %Response{code: 421, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.unprocessable_entity(%{status_kind: "4xx"})== %Response{code: 422, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.locked(%{status_kind: "4xx"})== %Response{code: 423, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.failed_dependency(%{status_kind: "4xx"})== %Response{code: 424, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.upgrade_required(%{status_kind: "4xx"})== %Response{code: 426, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.precondition_required(%{status_kind: "4xx"})== %Response{code: 428, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.too_many_requests(%{status_kind: "4xx"})== %Response{code: 429, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.request_header_fields_too_large(%{status_kind: "4xx"})== %Response{code: 431, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
      assert Response.unavailable_for_legal_reasons(%{status_kind: "4xx"})==  %Response{code: 451, body: ~s<{"status_kind":"4xx"}>, headers: %{}}
    end
